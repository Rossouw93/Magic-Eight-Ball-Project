var userName = 'Francois';

if (userName === '') {console.log('Hello!');
} 
else {console.log(`Hello, ${userName}!`)};

var userQuestion = 'Should I marry my girlfriend';

console.log(`Magic Eight Ball, ${userName} asked ${userQuestion}?`);
